...
export const clearCompletedTodoListAsync = createAsyncThunk("todos/clearCompletedTodoListAsync", async (data) => {
      const response = await axios.put(`${process.env.REACT_APP_API_BASE_ENDPOINT}/todos`, data);    
